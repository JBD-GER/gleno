        ...
        <div className="absolute right-0 z-10 mt-2 w-52 overflow-hidden rounded-lg border border-gray-200 bg-white shadow-lg">
          <ul className="divide-y divide-gray-100">
            <li>
              <button
                onClick={() => {
                  addHeading(positions, setPositions)
                  setOpen(false)
                }}
            ...
            <li>
              <button
                onClick={() => {
                  addDescription(positions, setPositions)
                  setOpen(false)
                }}
                className="block w-full px-4 py-2 text-left text-sm text-gray-800 hover:bg-gray-50"
              >
            ...
            <li>
              <button
                onClick={() => {
                  addItem(positions, setPositions)
                  setOpen(false)
                }}
                className="block w-full px-4 py-2 text-left text-sm text-gray-800 hover:bg-gray-50"
              >
            ...
            <li>
              <button
                onClick={() => {
                  addSubtotal(positions, setPositions)
                  setOpen(false)
                }}
                className="block w-full px-4 py-2 text-left text-sm text-gray-800 hover:bg-gray-50"
              >
            ...
            <li>
              <button
                onClick={() => {
                  addSeparator(positions, setPositions)
                  setOpen(false)
                }}
                className="block w-full px-4 py-2 text-left text-sm text-gray-800 hover:bg-gray-50"
              >
