        ...
        <div className="relative mx-auto max-w-6xl px-6 pt-10 pb-10 sm:pt-14 sm:pb-14">
          <div className="rounded-3xl border border-white/60 bg-white/70 p-6 text-center shadow-[0_20px_50px_rgba(2,6,23,0.06),0_2px_10px_rgba(2,6,23,0.04)] backdrop-blur-xl ring-1 ring-white/60 sm:p-10">
            ...
            <p className="mx-auto mt-3 max-w-2xl text-base leading-relaxed text-slate-700">
              Beschreibe dein Anliegen. Wir strukturieren automatisch Branche, Kategorie, Ausführung – inkl. KI-Einschätzung für Gesundheitsthemen und Budget-Tipps.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className={card}>
          ...
          {result && !loading && (
            <div className="space-y-5 relative">
              ...
              {/* Fullscreen Save-Overlay (dezent) */}
              {saving && (
                <div className="fixed inset-0 z-[60] bg-black/20 backdrop-blur-sm flex items-center justify-center">
                  <div className="rounded-2xl bg-white/90 border border-white/60 px-5 py-4 shadow-lg flex items-center gap-3">
                    <div className="h-5 w-5 rounded-full border-2 border-slate-400 border-t-transparent animate-spin" />
                    <div className="text-sm text-slate-800">Speichere Anfrage …</div>
                  </div>
                </div>
              )}
            </div>
