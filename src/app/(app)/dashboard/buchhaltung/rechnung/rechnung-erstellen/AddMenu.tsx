...
/* ------- Helper zum Hinzufügen von Positionen (unverändert) ------- */
...
/* ------- Neues, „sexy“ Add-Menü mit mobilem Verhalten ------- */
export default function AddMenu({ positions, setPositions }: AddMenuProps) {
  ...
  return (
    <div ref={ref} className="relative inline-flex">
      ...
      {/* Dropdown – auf Mobile links ausgerichtet, damit nichts hinausrutscht */}
      {open && (
        <div
          className="
