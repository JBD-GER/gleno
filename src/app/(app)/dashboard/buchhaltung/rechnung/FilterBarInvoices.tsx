...
export default function FilterBarInvoices() {
  ...
  const apply = (patch: Partial<{ q: string; sort: 'desc' | 'asc' }>) => {
    ...
    params.delete('page') // immer auf Seite 1 springen
        ...
        <div className="flex-1">
          ...
          <div className="relative">
            <input
              ...
              placeholder="Suche in Rechnungsnr., Titel, Intro, Datum, Kunde…"
            ...
            {q && (
              <button
                onClick={() => setQ('')}
                className="absolute right-2 top-1/2 -translate-y-1/2 rounded px-2 text-sm text-slate-600 hover:bg-white"
              >
                ×
              </button>
            )}
