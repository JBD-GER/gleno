...
type Status = 'Lead' | 'Kunde' | 'Deaktiviert' | 'alle'
        ...
        <div className="flex-1">
          ...
          <div className="relative">
            <input
              ...
              // ⬇️ Firma im Placeholder benennen
          ...
          {/* Kleiner Hinweischip, wenn gesucht wird */}
          {q && (
            <div className="mt-1 text-[11px] text-slate-500">
              Suche aktiv für: <span className="font-medium">„{q}“</span> (inkl. <span className="italic">Firma</span>)
            </div>
          )}
        </div>
